...
* **[Advanced Variations](/guide/product-types-creation/advanced-variations):** Build products from reusable attributes like Color and Size, and let FluentCart generate every variant combination automatically.
...
* **[Advanced Inventory](/guide/product-types-creation/advanced-inventory):** A dedicated Pro workspace for central stock management, bulk updates, adjustment history, and export.
