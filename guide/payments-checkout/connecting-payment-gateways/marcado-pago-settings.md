...
![Marcado Pago Install & Activate](/guide/public/images/payments-checkout/marcado-pago/install-activate-marcado-pago-1.webp)
...
![Payment Activation](/guide/public/images/payments-checkout/marcado-pago/payment-activation-3.webp)
...
![Create Application](/guide/public/images/payments-checkout/marcado-pago/create-application-4.webp)

2.  Enter your **Application name** and click **Continue**.

![Application Name](/guide/public/images/payments-checkout/marcado-pago/application-name-5.webp)

3.  Select **Online payments** and choose the option to create your store. Click on the **Continue** button.

![Online Payment](/guide/public/images/payments-checkout/marcado-pago/online-payment-6.webp)
...
![Copy Public Key & Access Token](/guide/public/images/payments-checkout/marcado-pago/copy-public-key-7.webp)
...
![Configure Notification](/guide/public/images/payments-checkout/marcado-pago/configure-notification-8.webp)
...
![Configure Webhook Notification](/guide/public/images/payments-checkout/marcado-pago/configure-webhook-notification-9.webp)
...
![Add To FluentCart](/guide/public/images/payments-checkout/marcado-pago/save-settings-10.webp)
