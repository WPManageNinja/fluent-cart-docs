...
FluentCart is built to be as theme-agnostic as possible. For any theme, you can use our powerful [**FluentCart Blocks**](/guide/customization-and-themes/using-fluentcart-blocks-&-templates) in the WordPress editor or place our [**shortcodes**](/guide/settings-configuration/pages-setup) to display products, checkout forms, and customer dashboards. This ensures that you can build a fully functional and beautiful storefront, no matter which theme you choose.