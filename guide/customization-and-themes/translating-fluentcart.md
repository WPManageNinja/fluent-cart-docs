...
![Activating the Loco Translate plugin from the WordPress plugins page.](/guide/public/images/customization-and-themes/translating-fluentcart/loco-translate-activate.webp)
...
2.  You will see a list of all your installed plugins. Click on **FluentCart** to begin. (You will repeat these steps for **FluentCart Pro** later.)
    ...
    ![The Loco Translate plugins list](/guide/public/images/customization-and-themes/translating-fluentcart/loco-translate-fluentcart.webp)

3.  Click the **+ New language** link to add your translation file.

    ![Clicking the 'New language' link in Loco Translate.](/guide/public/images/customization-and-themes/translating-fluentcart/new-language.webp)
...
5.  Click the **Start translating** button.
    ...
    ![Select Language Location](/guide/public/images/customization-and-themes/translating-fluentcart/select-language-location.webp)
...
7.  Once you have finished translating the free version, go back to **Loco Translate → Plugins** and repeat the same steps for **FluentCart Pro** to ensure all features are translated.
    ...
    ![Clicking the Save button](/guide/public/images/customization-and-themes/translating-fluentcart/save-button.webp)
...
![Setting the Site Language in WordPress General Settings](/guide/public/images/customization-and-themes/translating-fluentcart/general-settings.webp)
...
![Viewing the successfully translated helper text in the FluentCart Store Setup settings.](/guide/public/images/customization-and-themes/translating-fluentcart/previewing-translation.webp)
