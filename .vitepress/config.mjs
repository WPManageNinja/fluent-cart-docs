    ...
    sidebar: {
      '/guide/': [
          ...
          items: [
            {
              ...
              link: '/guide/product-types-creation/',
              items: [
                ...
                { text: 'Creating & Managing Product Brand', link: '/guide/product-types-creation/creating-managing-product-brand' },
        ...
        },
        {
          ...
          items: [
            { text: 'Store Management Overview', link: '/guide/store-management/' },
            {
              ...
              link: '/guide/store-management/orders-management/',
              items: [
            ...
            },
            {
              ...
              link: '/guide/store-management/customers-management/',
              items: [
        ...
        },
        {
          ...
          items: [
            { text: 'Payments & Checkout Overview', link: '/guide/payments-checkout/' },
            {
              ...
              link: '/guide/payments-checkout/connecting-payment-gateways/',
              items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Shipping Overview', link: '/guide/shipping/' },
          ...
          items: [
            {
              ...
              link: '/guide/marketing-sales-tools/creating-managing-coupons/',
              items: [
        ...
        },
        {
          ...
          items: [
            {
              text: 'Store Settings',
              link: '/guide/settings-configuration/store-settings',
              items: [
            ...
            { text: 'Configuring Webhooks', link: '/guide/settings-configuration/configuring-webhooks' },
            {
              ...
              link: '/guide/settings-configuration/email-configuration/',
              items: [
            ...
            },
            {
              ...
              link: '/guide/settings-configuration/roles-permissions/',
              items: [
